        ...
        if (Selection.activeGameObject.GetComponent<TileMap>() != null)
        {
            ...
            if (selectedGameObject != null)
            {
                ...
                { 
                    ...
                    Event cE = Event.current; Vector2 tS = new Vector2(cE.mousePosition.x - 5, cE.mousePosition.y); if (Event.current.type == EventType.mouseDown && Event.current.button == 0)
                    {
                    ...
                    GUIStyle style = new GUIStyle(GUI.skin.customStyles[0]); style.normal.background = boxTex;
